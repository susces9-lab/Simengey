-- SWILL ULTIMATE TELEPORTER [FULL VERSION]
-- Единый скрипт (все части объединены)
...
local function setSpeed(value)
    ...
    addLog("Скорость установлена: " .. value)
end
...
local function setInvisibility(value)
    ...
    addLog(value and "Невидимость включена" or "Невидимость выключена")
end
...
playerDropdown = TeleportTab:CreateDropdown({
    ...
    Callback = function(opt)
        ...
        addLog("Выбран игрок: " .. (selectedPlayer and selectedPlayer.Name or "None"))
    end
})
...
TeleportTab:CreateButton({Name = "ТЕЛЕПОРТ К ВЫБРАННОМУ", Callback = function()
...
VisualTab:CreateToggle({Name = "ESP", CurrentValue = false, Flag = "ESP", Callback = function(v)
    espEnabled = v
    updateESP()
    addLog(v and "ESP включён" or "ESP выключен")
end})
...
MoveTab:CreateToggle({Name = "Бесконечный прыжок", CurrentValue = false, Flag = "Jump", Callback = function(v)
    ...
    addLog(v and "Бесконечный прыжок включён" or "Бесконечный прыжок выключен")
end})
MoveTab:CreateToggle({Name = "Noclip", CurrentValue = false, Flag = "Noclip", Callback = function(v)
    noclipEnabled = v
    updateNoclip()
    addLog(v and "Noclip включён" or "Noclip выключен")
end})
MoveTab:CreateToggle({Name = "Антипадение", CurrentValue = false, Flag = "NoFall", Callback = function(v)
    noFallEnabled = v
    if v then setupNoFall() end
    addLog(v and "Антипадение включено" or "Антипадение выключено")
end})
MoveTab:CreateToggle({Name = "Невидимость", CurrentValue = false, Flag = "Invis", Callback = function(v)
    invisibleEnabled = v
    setInvisibility(v)
end})
MoveTab:CreateToggle({Name = "Полёт V3", CurrentValue = false, Flag = "Fly", Callback = function(v)
    flyEnabled = v
    if v then startFly() else stopFly() end
    addLog(v and "Полёт включён" or "Полёт выключен")
end})
...
setSpeed(16)
addLog("✅ Скрипт полностью загружен!")
